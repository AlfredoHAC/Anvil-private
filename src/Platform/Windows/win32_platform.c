...
static LRESULT _ProcessEvent(NativeWindow* window, UINT umsg, WPARAM wparam, LPARAM lparam)
{
    ...
    {
        Event event = {
            .type = KeyPress, .handled = false, .key_press = {.key_code = (uint16)wparam, .modifier_set = 0}};
    ...
    {
        Event event = {
            .type = KeyRelease, .handled = false, .key_release = {.key_code = (uint16)wparam, .modifier_set = 0}};
    ...
    case WM_LBUTTONDOWN:
    {
        Event event = {.type = MouseButtonClick,
                       .handled = false,
                       .mouse_button_click = {.button_code = 1,
    ...
    case WM_MBUTTONDOWN:
    {
        Event event = {.type = MouseButtonClick,
                       .handled = false,
                       .mouse_button_click = {.button_code = 2,
                                              .x = (float32)GET_X_LPARAM(lparam),
                                              .y = (float32)GET_Y_LPARAM(lparam),
                                              .modifier_set = 0}};
    ...
    case WM_RBUTTONDOWN:
    {
        Event event = {.type = MouseButtonClick,
                       .handled = false,
                       .mouse_button_click = {.button_code = 3,
                                              .x = (float32)GET_X_LPARAM(lparam),
                                              .y = (float32)GET_Y_LPARAM(lparam),
                                              .modifier_set = 0}};
    ...
    case WM_XBUTTONDOWN:
    {
        Event event = {.type = MouseButtonClick,
                       .handled = false,
                       .mouse_button_click = {.button_code = (uint8)GET_XBUTTON_WPARAM(wparam),
                                              .x = (float32)GET_X_LPARAM(lparam),
                                              .y = (float32)GET_Y_LPARAM(lparam),
                                              .modifier_set = 0}};
    ...
    case WM_LBUTTONUP:
    {
        Event event = {.type = MouseButtonRelease,
                       .handled = false,
                       .mouse_button_release = {.button_code = 1,
                                                .x = (float32)GET_X_LPARAM(lparam),
                                                .y = (float32)GET_Y_LPARAM(lparam),
                                                .modifier_set = 0}};
    ...
    case WM_MBUTTONUP:
    {
        Event event = {.type = MouseButtonRelease,
                       .handled = false,
                       .mouse_button_release = {.button_code = 2,
                                                .x = (float32)GET_X_LPARAM(lparam),
                                                .y = (float32)GET_Y_LPARAM(lparam),
                                                .modifier_set = 0}};
    ...
    case WM_RBUTTONUP:
    {
        Event event = {.type = MouseButtonRelease,
                       .handled = false,
                       .mouse_button_release = {.button_code = 3,
                                                .x = (float32)GET_X_LPARAM(lparam),
                                                .y = (float32)GET_Y_LPARAM(lparam),
                                                .modifier_set = 0}};
    ...
    case WM_XBUTTONUP:
    {
        Event event = {.type = MouseButtonRelease,
                       .handled = false,
                       .mouse_button_release = {.button_code = (uint8)GET_XBUTTON_WPARAM(wparam),
                                                .x = (float32)GET_X_LPARAM(lparam),
                                                .y = (float32)GET_Y_LPARAM(lparam),
                                                .modifier_set = 0}};
